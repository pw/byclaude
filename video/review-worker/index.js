...
const FILMS = {
  ...
  santafe: {
    ...
    sub: "Santa Fe and the Pueblo Revolt · 1610–1696 · film thirteen",
    mp4: "santafe.mp4", poster: "poster-santafe.png",
    meta: ["1920×1080 · 30fps", "27 beats", "voice: onyx", "−14 LUFS"],
    note: [
      "<span class='amber'>What this is:</span> Patrick's ask, straight up — what was life actually like in early Santa Fe. The hook is the Palace of the Governors' own claim to be \"believed to be the oldest continuously occupied public building in the United States\" (that's the National Park Service's real, hedged language) — and the record the agency's own Landmark nomination keeps: no fabric survives from before the Pueblo Revolt. The film uses that gap (1610 founding → 1696, where the record's own 'period of significance' begins) to walk through what actually filled it: an isolated, poor colony at the far end of a 1,600-mile road; a labor system built on ransomed captive children (genízaros); the 1680 Pueblo Revolt that expelled the entire Spanish colony for twelve years; a 'bloodless' 1692 reconquest that lasted exactly one year before real violence in 1693–94; and a 1909–13 restoration that invented the building's iconic front from an old map and one salvaged corbel.",
      "<span class='amber'>What to judge:</span> does the myth-then-record structure (established in No Farmers) carry a genuinely different, less-known story; does the genízaro material land as real social history rather than a detour; does the reconquest's second myth-vs-record turn (the 'bloodless' framing, punctured a second time) feel earned or repetitive after the opening one.",
      "<span class='amber'>Accuracy &amp; care:</span> built from three parallel research passes (founding/built environment, Pueblo Revolt/reconquest, daily life/genízaros) then an independent adversarial fact-check pass before building — which caught and fixed three real overclaims in the first draft: the script originally stated 1696 as a 'confirmed' date for surviving fabric (corrected — it's the Landmark nomination's own 'ca. 1696' hedge, not a dendrochronology finding); it said the 1909 restoration was a single-year, 'complete' rebuild (corrected to the actual 1909–13 span, with 'remade completely' softened since much period fabric was retained — only the style, and the iconic front portal specifically, was invented); and it claimed the Pueblo-occupied Palace housed 'a thousand people' across the full twelve-year interregnum (corrected — the sourced 1,000 figure is a single 1692 one-day negotiation headcount, not a steady occupation count, so that number was dropped). Every other load-bearing figure held up under the adversarial pass: the NPS's exact 'believed to be the oldest' language; the Camino Real's 1,600 miles; the 1601 Fray San Miguel epigraph (correctly dated nine years before Santa Fe existed, at the prior capital San Gabriel — not claimed as a Santa Fe quote); the genízaro figures (9,680 of 29,041, one 1793 count, per historian Ramón Gutiérrez); Abiquiú's 1754 land grant; Popé's 1675 whipping (not hanging — three other men were hanged, not him); the knotted-cord revolt coordination and August 10, 1680 date; 400 colonists and 21 friars killed (the total friar count is genuinely disputed 32-vs-33 across sources, so no ratio is asserted); the 1,946 refugees (Otermín and García's combined columns, correctly framed as the whole colonial contingent, not Spanish colonists alone); and the December 1693 breakdown of 81 dead (9 battle, 2 suicide, 70 executed) plus 400 enslaved for ten years, both exact matches to John Kessell's NPS-published account, itself sourced to Vargas's own 1693 journal entries. Nothing graphic; no imagery of people at all, per house style."
    ],
    source: "source: Palace of the Governors National Historic Landmark Nomination (NPS, NRHP #66000489) · John L. Kessell, <i>Kiva, Cross, and Crown</i> (NPS, 1979) · Hammond &amp; Rey, <i>Don Juan de Oñate, Colonizer of New Mexico</i> · Ramón Gutiérrez, <i>When Jesus Came, the Corn Mothers Went Away</i> (1991) · byclaude.net"
  },
  staugustine: {
    title: "Permanent",
    ...
    note: [
      ...
      "<span class='amber'>Accuracy &amp; care:</span> built from two parallel primary-source research passes (founding + built environment; daily life + material culture — a third agent on Timucuan contact/threats stopped mid-pass with no WebSearch access, the relevant material was covered organically by the other two) then an independent adversarial fact-check pass that caught and fixed NINE real first-draft errors: (1) Jamestown arithmetic — Forty-two years older, not eighty-one (1607 − 1565 = 42); (2) geography conflation — Matanzas is the inlet 14 miles south where the Huguenots were massacred, NOT the founding bay of St. Augustine; (3) Seloy food list — \"oysters\" is NOT on NPS's documented first-meal list; verified: maize, beans, squash, mullet, drum, turkey, venison, gopher tortoise (NPS First Thanksgiving); (4) reversed attribution of the LeConte petition — the French barber-surgeon petitioned <i>for a raise</i>; the governor's \"men would die like animals\" line was his <i>agreement</i> to that petition, not a separate petition to retain him (FMNH Disease &amp; Disaster); (5) Nombre de Dios is just north of the Castillo on the mainland, NOT \"across the bay\"; (6) the NPS slogan's fuller context restored so \"first\" qualifies the act of thanksgiving, not the settlement; (7) the Patiño/San Vicente captains restored to the Fr. López ellipsis so \"ordered a ditch and moat\" keeps its grammatical subject; (8) the Avilés Street \"century-and-a-half younger\" framing softened (open-web NPS/FMNH pages don't pin Avilés Street specifically — \"centuries younger, most of what still stands is post-1702, not from the wooden town\"); (9) the \"eight wooden forts\" count softened to \"a succession of wooden forts\" since the total of eight is not stated on any fetched open-web page. Every other load-bearing figure held up under adversarial verification: the September 8 1565 founding date; the 800 colonists (500 soldiers / 200 seamen / 100 others / 26 soldiers' wives — corroborated three ways across FMNH Colonists + NPS First Thanksgiving + NPS African Americans); the Castillo groundbreaking October 2 1672 (NPS, exact date); the 107-year gap to groundbreaking; the 400,000 pesos / eight years of unpaid stipend / \"close to starving\" (NPS Founding of Castillo, verbatim); Doña María Meléndez's 1587 corn rescue of the town (FMNH Church and the Missions); the 50 Africans, free and enslaved, in the 1565 founding party; the 1595 first recorded African-American birth; the LeConte and López and Drake's-board-and-thatch epigraphs (all verbatim from FMNH); the 1702 Moore siege and the coquina-absorbed-the-cannon-shot detail (NPS Siege of 1702 + NPS Coquina verbatim); and both the \"oldest continuously occupied European town in the United States\" slogan AND the \"Spanish Exodus\" exhibit-section title both on the same FMNH site.",
      "<span class='amber'>Production note:</span> first production use of <b>nano-banana-2-lite</b> (kie.ai's new cheap-bulk $0.02–0.08/image tier) end-to-end for the channel — the cost-curve move under load. 13 stills rendered, ~$1 total, no visible quality regression from the channel's gpt-image-2 house look per structural inspection; final visual QI is Patrick's, as always."
    ],
    source: "source: National Park Service — Castillo de San Marcos, Fort Matanzas, the First Thanksgiving, the Founding of Castillo de San Marcos, Coquina: The Rock that Saved St. Augustine, the Siege of 1702, African Americans in St. Augustine 1565–1821, the British Period · Florida Museum of Natural History \"St. Augustine: America's Ancient City\" exhibit (Kathleen Deagan) — founding, colonists, timeline, disasters &amp; rebuilding, the church &amp; the missions, disease &amp; disaster, life on the remote frontier, the Timucua in St. Augustine · byclaude.net"
  },
  pennsauken: {
  ...
  passengerlists: {
    title: "The Passenger Lists",
    sub: "Who actually settled English America · 1587–1625",
    mp4: "passengerlists.mp4", poster: "poster-passengerlists.png",
    meta: ["1920×1080 · 30fps", "21 beats", "voice: ballad", "−14 LUFS"],
    note: [
      "<span class='amber'>What this is:</span> Patrick's model-bakeoff prompt off the Roanoke short — who were the earliest settlers, walks of life, primary sources if possible. The answer this film gives: follow the paperwork. The founding myth pictures pioneer farming families; the surviving rosters, letters, and Privy Council minutes describe something else — a colony of 46 gentlemen and zero farmers (the Jamestown manifest is rendered as a ledger card, 'Farmers … 0' in amber), a painter governing Roanoke, London street children shipped against their will, brides carrying skills testimonials, a teenage bound servant begging his parents for redemption, and some thirty Ndongo captives traded for food at Point Comfort. Five verbatim primary documents carry the spine on a new 'source' card kind (archival catalog label + amber-ruled quote): John White's trumpet-and-songs return to the empty colony (Hakluyt 1600), Smith's 'rude Answer' (thirty carpenters rather than a thousand of such as we have), Bradford's 'no freinds to wellcome them,' Richard Frethorne's 1623 letter home ('I thought no head had beene able to hold so much water…'), and Rolfe's '20. and odd Negroes, bought for victualls.' One honest-frame beat up front concedes 'first' is English bookkeeping — an inhabited continent, Spanish Florida decades older — before following the English paper trail because that's where the diaries are.",
      "<span class='amber'>What to judge:</span> whether the documents-as-protagonist frame (two new card kinds: 'source' archival quotes, 'roster' manifest ledger) earns its higher card density — 8 of 21 beats are typographic; whether ballad at a gentle 1.15× native speed holds warmth through the heaviest stretch (Frethorne → children → White Lion) without drifting into true-crime grimness; and whether the 5:25 runtime — longest in the ballad lane — is carried by the material or should have been cut to four minutes.",
      "<span class='amber'>Accuracy &amp; care:</span> five parallel research passes ran BEFORE a word was drafted, each returning verbatim excerpts verified character-for-character against scholarly transcriptions (Kingsbury's <i>Records of the Virginia Company</i> vols. I–IV on archive.org, Hakluyt via Virtual Jamestown + the 1904 MacLehose reprint, Bradford via Project Gutenberg #24950, Tyler's <i>Narratives of Early Virginia</i>). Catches that shaped the script: the famous Frethorne mourning line is NOT in the classroom transcriptions everyone cites (they stop at March 20; it's in the April 3 installment, Kingsbury 4:62); Bradford was a FUSTIAN weaver per the 1613 Leiden betrothal records, not the 'silk weaver' of mayflowerhistory.com's wording; the Jamestown list survives in two disagreeing primary versions (1612: 105; 1624: 100 — the film says 'about one hundred four,' Percy's own count); 'CRO' was on the tree and 'CROATOAN' on the palisade post, not both on a tree; the tobacco brides were NOT coerced (the Company's own letters bar forced marriage — 'the libertie of Mariadge we dare not infrindg' — so the film pointedly does not group them with the children, whose Privy Council coercion order of 31 Jan 1620 IS quoted verbatim); the 'families be planted… fix the people on the soil' line usually credited to Sandys is actually the Company's Aug 1621 letter and is not used; Frethorne's death is stated only as the Feb 1623/4 muster listing him among the dead, cause unclaimed. The children's survival figure (~12 of ~300 alive by 1625) is presented as the scholars' muster-count estimate (Johnson 1970 via Jordan &amp; Walsh). Every source-card quote is contiguous verbatim text, original spelling, no editorial brackets voiced.",
      "<span class='amber'>Production note:</span> built as a blind bakeoff arm — the daily log's summary of the other model's session was unavoidably seen at session-open (flagged to Patrick immediately), so the research was re-run from scratch by five fresh agents and no other-arm files were opened. Also the first film to use TTS speed control: ballad's native pace ran the script to 6:51, so narration was trimmed ~15% and rendered at speed 1.15, then every beat whisper-re-transcribed to confirm no silent truncation (all 21 clean)."
    ],
    source: "source: Kingsbury, <i>Records of the Virginia Company</i> I–IV · Hakluyt, <i>Principal Navigations</i> (1600) · Smith, <i>Generall Historie</i> (1624) · Percy, <i>Observations</i> (1625) · Bradford, <i>Of Plymouth Plantation</i> (Gutenberg #24950) · Acts of the Privy Council, Colonial I · Jeaffreson, <i>Middlesex County Records</i> II · Encyclopedia Virginia · mayflowerhistory.com · Hampton History Museum ('1619: Virginia's First Africans') · byclaude.net"
  }
};
