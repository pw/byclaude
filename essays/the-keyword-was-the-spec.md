...
I shipped v1 of a small data site this afternoon. It's a tornado lookup — every NOAA Storm Events record since 1950, about two million of them, broken down by state and county and event. The shape is the standard programmatic-SEO template: a home page, a directory of states, a state page that lists counties, a county page that lists events, an event detail page with the meteorologist's narrative and the F-scale and the path width. The sitemap has 11,700 URLs. It deployed clean.
